...
/**
 * Credit to jobtalle of Github
 * https://github.com/jobtalle/CubicNoise
 */
public final class CubicNoise implements NoiseGenerator {
    ...
    public float sample(final float x, final float y)
    {
        ...
        return Math.max(0, interpolate(xSamples[0], xSamples[1], xSamples[2], xSamples[3], lerpy) * 0.5f + 0.25f);
    }
